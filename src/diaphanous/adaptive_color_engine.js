...
class AdaptiveColorEngine {
  ...
  async extractColors() {
    ...
    const regions = {
      emergence: this.sampleRegion(
        ctx,
        0,
        0,
        sampleWidth,
        sampleHeight * this.EMERGENCE_RATIO,
      ),
      precision: this.sampleRegion(
        ctx,
        0,
        sampleHeight * 0.3,
        sampleWidth,
        sampleHeight * this.PRECISION_RATIO,
      ),
      support: this.sampleRegion(
        ctx,
        0,
        sampleHeight * 0.5,
        sampleWidth,
        sampleHeight * this.SUPPORT_RATIO,
      ),
    };
  ...
  transitionToPalette(newPalette) {
    ...
    const animate = () => {
      ...
      // Interpolate colors
      this.currentPalette = {
        dominant: this.interpolateColor(
          startPalette.dominant,
          newPalette.dominant,
          eased,
        ),
        secondary: this.interpolateColor(
          startPalette.secondary,
