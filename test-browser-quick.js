...
async function testBrowserFeatures() {
  ...
  const elementsToTest = [
    ...
    // Tab Management
    {
      class: "new-tab",
      name: "New Tab Button",
      expectedBehavior: "creates tab",
    },
    {
      class: "tab-close",
      name: "Tab Close Button",
      expectedBehavior: "closes tab",
    },
    ...
    {
      id: "na-indicator",
      name: "Natural Asymmetry Indicator",
  ...
  console.log(
    `  Unwired/Partial: ${results.unwired.length} (${unwiredPercent}%)`,
  );
