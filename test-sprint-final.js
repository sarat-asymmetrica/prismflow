...
function setupAllHandlers() {
    ...
    // Tabs
    ipcMain.handle('create-tab', (event, url) => createTab(url || 'https://duckduckgo.com'));
...
// Write preload
fs.writeFileSync(path.join(__dirname, 'src', 'preload-sprint.js'), preloadContent);
