...
console.log(
  "⚡ Starting PrismFlow Browser with Universal Optimization Engine...",
);
...
function createWindow() {
  ...
  win.webContents.on("did-finish-load", () => {
    ...
    console.log(
      "⚡ Click the lightning bolt button to open Performance Optimizer",
    );
    console.log(
      "🚀 Using frequency-based optimization (108Hz, 216Hz, 432Hz, 528Hz)",
    );
...
console.log(
  "🌟 Natural Asymmetry working silently in the background (30/20/50)",
);
