      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <Select
              value={userRole}
              onValueChange={(value: unknown) => setUserRole(value as UserRole)}
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          ...
          {visibleMetrics.includes("orders") && (
            <MetricCard
              ...
              sparklineData={metrics.orders.history.map((h: unknown) => ({
                date: h.date,
                value: h.count,
              }))}
              ...
              onClick={() =>
                openDrillDown(
                  ...
                  false,
                  {
                    historicalData: metrics.orders.history.map(
                      (h: unknown) => ({
                        date: h.date,
                        value: h.count,
                      }),
            ...
            <ResponsiveContainer width="100%" height={280}>
              ...
              >
                ...
                <Bar dataKey="value" radius={[0, 8, 8, 0]}>
                  {charts.pipelineFunnel.map(
                    (entry: unknown, index: unknown) => (
                      <Cell
                        key={`cell-${index}`}
                        fill={
                          ["#FF9800", "#8B5CF6", "#3B82F6", "#06D6A0"][index]
                        }
                      />
                    ),
                  )}
